...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MBLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9MBLibrary17EnhancedTextField")
@interface EnhancedTextField : UITextField
...
SWIFT_CLASS("_TtC9MBLibrary10FadedLayer")
@interface FadedLayer : CALayer
- (nonnull instancetype)initWithLayer:(id _Nonnull)layer;
...
SWIFT_CLASS("_TtC9MBLibrary20InAppPurchaseManager")
...
@interface InAppPurchaseManager (SWIFT_EXTENSION(MBLibrary)) <SKProductsRequestDelegate>
...
@interface InAppPurchaseManager (SWIFT_EXTENSION(MBLibrary)) <SKPaymentTransactionObserver>
...
SWIFT_CLASS("_TtC9MBLibrary17MinHeightTextView")
@interface MinHeightTextView : UITextView
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)textChanged:(NSNotification * _Nonnull)not_;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC9MBLibrary13OutlinedLabel")
...
SWIFT_CLASS("_TtC9MBLibrary17PopoverController")
@interface PopoverController : NSObject <UIPopoverPresentationControllerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC9MBLibrary12SlidingLabel")
@interface SlidingLabel : UIView
- (nonnull instancetype)init;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC9MBLibrary15VariableToolbar")
@interface VariableToolbar : UIToolbar
...
SWIFT_CLASS("_TtC9MBLibrary7XMLNode")
...
- (void)setWithContent:(NSString * _Nullable)s;
- (void)addWithAttribute:(NSString * _Nonnull)a withValue:(NSString * _Nonnull)v;
- (void)addWithChild:(XMLNode * _Nonnull)c;
@end
